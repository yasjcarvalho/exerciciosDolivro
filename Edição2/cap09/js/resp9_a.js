...
const contarVisitas = () => {
    ...
    if (contador == 1){
        resp.innerText = "Muito Bem-Vindo! Esta é sua primeira visita ao nosso site."
    } else {
        resp.innerText = `Que bom que você voltou! Está é a sua visita de número ${contador} ao nosso site.`
    }
